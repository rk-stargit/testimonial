...
function Testimonial(props) {
  ...
  return (
    <div className="flex flex-col w-[85vw] md:w-[700px] bg-white justify-center items-center mt-10 p-10 hover:shadow-xl  transition-all duration-700 rounded-md">
      <Card review={reviews[index]} />
      <div className="flex text-3xl mx-auto mt-9 gap-3 text-violet-400 font-bold">
        <button
          onClick={leftShiftHnadler}
